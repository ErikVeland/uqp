---
  ...
  subtitle: Lists all changes to each version of helpers
  layout: docs.hbs
---
...
- Moved font family CSS into app.scss from helpers module.
...
- Moved loader watches into helpers run (catches events earlier)
