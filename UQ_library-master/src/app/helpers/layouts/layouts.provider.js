(function() {
    ...
    function layoutProvider() {
        var layoutDefaults = {
            ...
            showToolbar: true,
            footer: true,
            contentTemplateUrl: 'app/helpers/layouts/default/default-content.tmpl.html',
            sidebarLeftTemplateUrl: 'app/helpers/components/menu/menu.tmpl.html',
            sidebarLeftController: 'MenuController',
            sidebarRightTemplateUrl: 'app/helpers/components/notifications-panel/notifications-panel.tmpl.html',
            sidebarRightController: 'NotificationsPanelController',
            toolbarTemplateUrl: 'app/helpers/components/toolbars/toolbar.tmpl.html',
            toolbarController: 'DefaultToolbarController',
            footerTemplateUrl: 'app/helpers/components/footer/footer.tmpl.html'
        };
