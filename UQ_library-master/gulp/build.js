...
gulp.task('html', ['inject', 'partials'], function () {
  ...
  var htmlFilter = $.filter(['*.html', '!/src/app/elements/components/*.html'], {restore: true});
...
gulp.task('identity', function () {
  return gulp.src(paths.src + '/identity/*')
    .pipe(gulp.dest(paths.dist + '/identity/'));
});
...
gulp.task('buildapp', ['identity', 'env', 'html', 'images', 'fonts', 'misc', 'data', 'componentsjs']);
